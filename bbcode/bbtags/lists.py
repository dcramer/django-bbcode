...
[/ol][/code]
    ...
    close_pattern = re.compile(patterns.closing % 'ol', re.I)
...
[/ul][/code]
    ...
    def open_pattern():
        ...
        pat += r'\]'
        return re.compile(pat, re.I)
    close_pattern = re.compile(patterns.closing % 'ul', re.I) 
...
class List(UL):
    ...
    Usage:
        ...
        [code lang=bbdocs linenos=0][list]
  [*] First item
  [*] Second item
[/list][/code]
    """
    ...
    def open_pattern():
        ...
        pat += r'\]'
        return re.compile(pat, re.I)
    close_pattern = re.compile(patterns.closing % 'list', re.I) 
    verbose_name = 'Unordered List'
